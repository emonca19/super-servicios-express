...
.vehicles { height: 100%; min-height: 100%; padding-bottom: 2rem; overflow-y: auto; }
.vehicles::-webkit-scrollbar { width: 8px; }
.vehicles::-webkit-scrollbar-thumb { background: #c1c1c1; border-radius: 20px; }
.vehicles::-webkit-scrollbar-track { background: #f1f1f1; border-radius: 20px; }
...
.new-vehicle-btn { background: #ff8a00; color: white; border: none; padding: .65rem 1.4rem; font-size: 14px; border-radius: 8px; cursor: pointer; transition: all 0.25s ease; font-weight: 500; white-space: nowrap; }
.new-vehicle-btn:hover { background: #e67a00; transform: translateY(-2px); box-shadow: 0 4px 8px rgba(255, 138, 0, 0.3); }

@media (max-width: 768px) { .top-bar { flex-direction: column; align-items: stretch; } .new-vehicle-btn { align-self: flex-end; } }

/* --- ESTILOS DE MODAL (IDÉNTICOS A CLIENTES) --- */
...
.field-input { width: 100%; padding: 0.55rem 0.8rem; border-radius: 0.7rem; border: 1px solid #e5e7eb; font-size: 0.9rem; outline: none; background-color: #f9fafb; box-sizing: border-box; }
...
.delete-client-name { margin-top: 0.55rem; font-weight: 600; color: #111827; }
